...
class IrActionsReport(models.Model):
    ...
    hide_group_ids = fields.Many2many('res.groups', 'group_report_rel', 'report_id', 'group_id',
...
class FieldConfiguration(models.Model):
    ...
    group_ids = fields.Many2many('res.groups', 'field_config_group_rel', 'group_id', 'field_config_id', required=True,
                                 string='Groups')
