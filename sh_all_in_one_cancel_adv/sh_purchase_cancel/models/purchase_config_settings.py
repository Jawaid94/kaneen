...
class ResConfigSettings(models.TransientModel):
    ...
    po_operation_type = fields.Selection(default=lambda self: self.env.user.company_id.po_operation_type, string=" Opration Type", related="company_id.po_operation_type", readonly=False)
