...
class ResConfigSettings(models.TransientModel):
    ...
    operation_type = fields.Selection(default=lambda self: self.env.user.company_id.operation_type, string="Opration Type", related="company_id.operation_type", readonly=False)
